...
Na primeira vez que for utilizar esse pacote use o comando docker-compose up --build Depois, apenas docker-compose up
...
Esse serviço é um gerenciador do mongo, tal como Mongo Compass e Robo Mongo, para usar acesse a URL localhost:3000 Quando acessá-lo configure a conexão com o MongoDB do item anterior.
